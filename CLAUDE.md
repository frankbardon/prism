...
├── mcpserve/               # In-process MCP runner (sanctioned SDK importer): `Options` + `Serve(ctx, facade, opts, in, out)` + `ServeStdio(facade, opts)`
