...
func lightTheme() *Theme {
	...
	return &Theme{
		...
		Marks: map[string]*MarkStyle{
			...
			"sparkline":  {Stroke: "#4c78a8", StrokeWidth: f(1.5), Fill: "transparent"},
			"network":    {Fill: "#4c78a8", Stroke: "#4c78a8", StrokeWidth: f(1)},
			"tree":       {Fill: "#4c78a8", Stroke: "#4c78a8", StrokeWidth: f(1)},
			"dendrogram": {Fill: "#4c78a8", Stroke: "#4c78a8", StrokeWidth: f(1)},
