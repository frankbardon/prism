...
func highContrastTheme() *Theme {
	...
	return &Theme{
		...
		Marks: map[string]*MarkStyle{
			...
			"sparkline":  {Stroke: "#000000", StrokeWidth: f(2.5), Fill: "transparent"},
			"network":    {Fill: "#000000", Stroke: "#000000", StrokeWidth: f(1.5)},
			"tree":       {Fill: "#000000", Stroke: "#000000", StrokeWidth: f(1.5)},
			"dendrogram": {Fill: "#000000", Stroke: "#000000", StrokeWidth: f(1.5)},
