...
func printTheme() *Theme {
	...
	return &Theme{
		...
		Marks: map[string]*MarkStyle{
			...
			"sparkline":      {Stroke: "#000000", StrokeWidth: f(1.25), Fill: "transparent"},
			"network":        {Fill: "#000000", Stroke: "#000000", StrokeWidth: f(1)},
			"tree":           {Fill: "#000000", Stroke: "#000000", StrokeWidth: f(1)},
			"dendrogram":     {Fill: "#000000", Stroke: "#000000", StrokeWidth: f(1)},
			...
			"progress":       {Fill: "#555555", CornerRadius: f(0)},
			"progress_track": {Fill: "#cccccc"},
