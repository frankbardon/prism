...
func darkTheme() *Theme {
	...
	return &Theme{
		...
		Marks: map[string]*MarkStyle{
			...
			"sparkline":      {Stroke: primary, StrokeWidth: f(1.5), Fill: "transparent"},
			"network":        {Fill: primary, Stroke: primary, StrokeWidth: f(1)},
			"tree":           {Fill: primary, Stroke: primary, StrokeWidth: f(1)},
			"dendrogram":     {Fill: primary, Stroke: primary, StrokeWidth: f(1)},
			...
			"progress":       {Fill: primary, CornerRadius: f(0)},
			"progress_track": {Fill: "#374151"},
			...
			// box colour instead.
			"boxplot_median": {Stroke: "#0b1220", StrokeWidth: f(1)},
		},
		Axis: &AxisStyle{
			DomainColor:   "#9ca3af",
			DomainWidth:   f(1),
