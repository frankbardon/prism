...
// ScaleRangePosition implements PRISM_SPEC_045: `scale.range` is
...
// Code returns PRISM_SPEC_045.
func (ScaleRangePosition) Code() string { return "PRISM_SPEC_045" }
...
func checkScaleRangePosition(enc *spec.Encoding) []*errors.AppError {
	...
	check := func(channel string, ch *spec.PositionChannel) {
		...
		out = append(out, errors.New("PRISM_SPEC_045",
